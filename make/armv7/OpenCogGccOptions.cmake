...
IF (CMAKE_COMPILER_IS_GNUCXX)
	...
	IF (APPLE)
		...
		SET(CMAKE_C_FLAGS "-Wall -Wno-long-long -Wno-conversion ${AFLAGS}")
	...
	ELSE (APPLE)
		SET(CMAKE_C_FLAGS "-Wall -fPIC -fstack-protector ${AFLAGS}")
	...
	SET(CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS} -Wno-variadic-macros -fopenmp -std=gnu++17 ${AFLAGS}")
